<div id="update-role-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow border border-white">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t-lg bg-navside">
                ...
                <button type="button" id="close-btn"
                    ...
                    data-modal-hide="update-role-modal">
            ...
            <form method="POST" id="updateRoleForm">
                ...
                <div class="p-4 md:p-5">
                    <div class="mb-20">
                        <div>
                            <div class="mb-2">
                                <label for="updateName" class="block mb-2 text-sm font-medium text-gray-900 ">Name
                                </label>
                                <input type="text" id="updateName" name="name" aria-describedby="helper-text-explanation"
                ...
                <button type="button" id="buttonUpdateRole"
