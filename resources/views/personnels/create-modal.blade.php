<div id="create-personnal-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow border border-white">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t-lg bg-navside">
                ...
                <button type="button" id="close-btn"
                    ...
                    data-modal-hide="create-personnal-modal">
            ...
            <form method="POST" id="createPersonalForm">
                @csrf
                ...
                <button type="button" onclick="createPersonal(this.closest('form'))"
                ...
                <button type="submit" class="hidden" id="btnSubmitCreatePersonal">
                </button>
            </form>
        </div>
    </div>
